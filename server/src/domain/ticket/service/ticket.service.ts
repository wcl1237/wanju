...
import { Ticket, CreateTicketDTO, TicketStatus } from '../model/ticket.model';
...
export class TicketService {
  ...
  private toTicket(e: TicketEntity): Ticket {
    return {
      id: e.id, ticketNo: e.ticketNo || '', title: e.title, description: e.description,
      priority: e.priority as any, category: e.category as any, status: e.status as any,
